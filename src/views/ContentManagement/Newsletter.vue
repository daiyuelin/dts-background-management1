  ...
  <el-card style="height:90%">
    <div style="width:98%;height:40px;">
      <div  style="width:30%;float:left;text-align:left;padding-top:10px;height:46px">
        <span style="font-size:20px;font-weight: bold;margin-left:10px">Newsletter List</span>
      </div>
    ...
    >
      <el-form :form="formData.form" align="top" style="margin-right:50px" label-width="100px">
        ...
        <el-form-item label="pdf">
          <a v-for="hr in formData.form.filelist" :href="hr.url" :key="hr.id" @click="window.open(hr.url)">{{hr.url}}</a>
        </el-form-item>
        <el-form-item label="Date">
          <el-input disabled :value="formData.form.dateTime"></el-input>
        </el-form-item>
